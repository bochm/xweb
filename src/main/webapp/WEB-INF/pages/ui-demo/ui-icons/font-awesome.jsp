...
<div class="note note-success">
	<p>Font Awesome 4.2 图标,具体见:<a target="_blank" href="http://fortawesome.github.io/Font-Awesome/icons/">http://fortawesome.github.io/Font-Awesome/icons/</a></p>
	<pre>直接使用  &lt;i class="fa fa-automobile"&gt;&lt;/i&gt;</pre>
</div>
	<h3>71 个新图标</h3>
	...
	<div class="alert alert-success">
		<ul class="fa-ul">
			<li>
				...
				在图标定义标签使用 <code>fa-spin</code> class.目前不支持IE10-
			</li>
		</ul>
	</div>
	<div class="row margin-bottom-20">
